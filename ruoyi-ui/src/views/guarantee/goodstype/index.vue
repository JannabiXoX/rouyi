    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['guarantee:goodstype:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['guarantee:goodstype:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['guarantee:goodstype:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['guarantee:goodstype:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listGoodstype, getGoodstype, delGoodstype, addGoodstype, updateGoodstype } from "@/api/guarantee/goodstype";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "货物分类名不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除货物类型信息编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('guarantee/goodstype/export', {
        ...this.queryParams
